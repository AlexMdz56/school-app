...
export default function Alumno() {
    ...
    const deleteStudent = useMutation(api.functions.student.deleteStudent);
    ...
    const handleDelete = async () => {
        ...
        try {
            await deleteStudent({ id: alumno._id });
            router.push("/alumnos");
        } catch (error) {
            ...
            <Card className="max-w-2xl mx-auto">
                ...
                <CardContent className="space-y-6">
                    <div>
                        ...
                        <div className="p-2 bg-muted rounded-md">{alumno.matricula}</div>
                    </div>

                    <div>
                        <h3 className="font-medium text-sm text-muted-foreground mb-1">Nombre Completo</h3>
                        <div className="p-2 bg-muted rounded-md">{alumno.nombre}</div>
                    </div>

                    <div>
                        <h3 className="font-medium text-sm text-muted-foreground mb-1">Correo Electrónico</h3>
                        <div className="p-2 bg-muted rounded-md">{alumno.correo}</div>
                    </div>
                </CardContent>
            </Card>
