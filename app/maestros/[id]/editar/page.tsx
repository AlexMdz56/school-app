...
export default function EditarMaestro() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        await updateTeacher({
            id: maestro!._id,
            numEmpleado: formState.numEmpleado,
    ...
    return (
        <div className="w-full min-h-screen flex flex-col justify-center items-center px-4">
            <div className="w-full max-w-md mx-auto p-4 overflow-y-auto h-full md:h-auto flex flex-col">
                <h2 className="text-xl font-semibold text-center">Nuevo Alumno</h2>
            </div>
            <form
            ...
            >
                <div className={"flex flex-col mt-1"}>
                    ...
                    <input
                        ...
                        onChange={e => setFormState({ ...formState, numEmpleado: e.target.value })}
                        name="numEmpleado"
                        id="numEmpleado"
